...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: hqmAZKxn3lBH/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___0Prg7)}
      >
        {renderPlasmicSlot({
          defaultContents:
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___03GmS)}
      >
        <PlasmicImg__
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__q31Cl)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__zJjT4)}>
            {renderPlasmicSlot({
