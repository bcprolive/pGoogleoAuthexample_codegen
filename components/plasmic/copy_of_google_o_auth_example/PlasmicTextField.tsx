...
import Label from "../../Label"; // plasmic-import: qsBxJKXz_6A_/component
import TextInput from "../../TextInput"; // plasmic-import: M63gnljlnIZ4/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: zVKX4z2_8Jn-/component
import Description from "../../Description"; // plasmic-import: EKkFGmFBdsMZ/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: jBiZ6mVcaqvvQhNgAZtxJj/projectcss
import sty from "./PlasmicTextField.module.css"; // plasmic-import: WmESnHSkz6v5/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__raB9C, {
          [sty.freeBoxiconEnd__raB9Cs8Ya]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__raB9CODsT]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__raB9CbgeNn]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__qgozP, {
            [sty.freeBoxiconStart__qgozPoDsT]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__qgozPbgeNn]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__zzc6V)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__wp4, {
            [sty.freeBoxiconEnd__wp4S8Ya]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__wp4ODsT]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__qifFl)}
                role={"img"}
              />
            ),
